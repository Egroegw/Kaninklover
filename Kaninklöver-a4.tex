...
%  \textnormal{1NT}& 18--19& balanced, no 5cM\\
...
% \textnormal{1NT} after opener's $1\spadesuit$ is:
...
% (That said, I'd recommend using \textnormal{2NT}/$3\clubsuit$ as transfers to $3\clubsuit$/$3\diamondsuit$. I'm still unhappy with $2\spadesuit$ and $3\diamondsuit\heartsuit\spadesuit$.)
...
\subsubsection*{Canape}
 Kaniklöver also works with canape! You'd use canape on any $\diamondsuit\heartsuit/ \diamondsuit\spadesuit/ \heartsuit\spadesuit$ two-suited hand (everything else is still ``open your longest suit''). You can call some 5332 hands two-suited, but be ready to play quite a few 3-3 fits at the 2-level!
    ...
    %  \textnormal{2NT} & Strong and unbalanced\\
    %  \hline
    % \end{tabular}
    % \end{center}
    ...
    % \begin{tabular}{ |c|l| }
    %  \hline
    %  \multicolumn{2}{|c|}{\textit{After \textnormal{1NT} (X) $2\clubsuit$ -- $2\diamondsuit$ --}} \\
    %  \hline
    %  pass & 5+ diamonds \\
    %  $2\heartsuit$ & 44 in the majors \\
    %  \hline
...
%  \hline
%  $1\clubsuit$   & 12 & 1$2\clubsuit$  & gh    & 3x & \\
% $1\diamondsuit$ & 10 & $2\diamondsuit$ & 37   & \textnormal{3NT} &  5 \\
